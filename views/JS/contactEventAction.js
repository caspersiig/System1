...
if(C_name.value == '' || C_email.value == '' || C_text.value == ''){
    ...
    if(xhr.responseText == 'succes'){
        alert("SUCCESFUL - Thank you for the submission. We will review your request and get back to you as fast as possible. Best regards Top100Movies");
        C_name.value = ''
        C_email.value = ''
        C_subject.value = ''
        C_text.value = ''
